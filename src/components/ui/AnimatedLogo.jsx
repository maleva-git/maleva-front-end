  ...
  return (
    <div className="mb-12 text-center animate-bounce-in">
      <div 
        ...
        onClick={onClick}
      >
        <div className="w-20 h-20 bg-gradient-to-br from-[#0A66C2] to-[#2563EB] rounded-2xl flex items-center justify-center shadow-lg mb-6 transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 animate-float">
          <img
            src={logoSrc}
            alt={`${title} Logo`}
